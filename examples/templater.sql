...
--
--     banshee lint --config examples/templater.toml examples/templater.sql
--
-- (or drop the [templater] section into your banshee.toml). With the templater on,
