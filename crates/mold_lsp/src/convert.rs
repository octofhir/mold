//! Conversions between mold's byte offsets and LSP's UTF-16 positions, and
//! between mold diagnostics/edits and their LSP equivalents.

use lsp_types::{Diagnostic as LspDiagnostic, DiagnosticSeverity, NumberOrString, Position, Range};
use mold_hir::{Diagnostic as HirDiagnostic, Severity, TextEdit as HirEdit};
...
/// Converts a mold text edit to an LSP text edit.
