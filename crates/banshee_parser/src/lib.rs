...
//!
//! ```ignore
//! let parse = banshee_parser::parse("SELECT * FROM users");
...
pub use banshee_syntax::SyntaxKind;
...
mod tests {
    ...
    fn format_node(node: &banshee_syntax::SyntaxNode, indent: usize) -> String {
