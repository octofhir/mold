...
///
/// ```
/// use banshee_completion::triggers::detect_jsonb_trigger;
///
...
///
/// ```
/// use banshee_completion::triggers::detect_jsonpath_in_string;
///
...
///
/// ```ignore
/// use banshee_completion::triggers::detect_keyword_trigger;
///
